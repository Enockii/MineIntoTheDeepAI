...
public class MineIntoTheDeepHireDwarfMessage extends MineIntoTheDeepMessage<Void> {
    public MineIntoTheDeepHireDwarfMessage() {
        super(MineIntoTheDeepMessages.CLIENT_HIRE);
    }
